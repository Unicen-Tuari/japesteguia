   ...
   <!--  <div class="portfolio-modal modal fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-content">
            ...
            <div class="container">
                <div class="row"> -->
                    <!-- {foreach key=indice item=jugador from=$ipj} -->
                    <!-- <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body"> -->
                            <!-- Project Details Go Here -->
                           <!--  <h2>{$ipj[0]['nombre']}</h2>
                            <img class="img-responsive" src="{$img[0]['ruta_grande']}" alt="">
                            <h2>{$ipj[0]['nacionalidad']}</h2>
                            <h3><strong>Nacionalidad:</strong></h3><h4>{$ipj[0]['nacionalidad']}</h4>
                            <h4>{$jugador['fecha_nacimiento']}</h4> -->
                            
                            <h2>{$mat[0]['distribuidor']}</h2>

{include file="header.tpl" title=foo}
    ...
    <section id="portfolio" class="bg-light-gray">
        <div class="container">
            ...
            <!-- comienzo jugador -->
            <div class="row">
            {foreach key=indice item=jugador from=$jugadores}
                {if ($jugadores[$indice].tipo_jugador)=='Mundial'}
          
                <div class="col-md-4 col-sm-6 portfolio-item">
                   <a href="#modal_jugador" class="portfolio-link" data-toggle="modal" onClick="get_portfolio_jugador({$jugador['id_jugador']});" >
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                        </div>
                        <img src="{$jugador['ruta']}" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>{utf8_encode($jugador['nombre'])}</h4>
                        <p class="text-muted">{$jugador['nacionalidad']}</p>
                    </div>
                </div>
                {/if}
            {/foreach}
    ...
    <section id="portfolio2" class="bg-light-gray">
        <div class="container">
            ...
            <div class="row">
            {foreach key=indice item=jugador from=$jugadores}
                {if ($jugadores[$indice].tipo_jugador)=='Nacional'}
                ...
                {/if}
            {/foreach}
            <!-- <a href="index.php?action=mostrarJugador&id={$jugador['id_jugador']}" class="portfolio-link" data-toggle="modal"> -->
